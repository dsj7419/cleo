...
if [[ -f "$_AW_LIB_DIR/exit-codes.sh" ]]; then
    # shellcheck source=lib/exit-codes.sh
    source "$_AW_LIB_DIR/exit-codes.sh"
else
...
if [[ -f "$_AW_LIB_DIR/platform-compat.sh" ]]; then
    # shellcheck source=lib/platform-compat.sh
    source "$_AW_LIB_DIR/platform-compat.sh"
else
